<div class="index_small">
    <div class="small_top">
        	<a href="/team.php?id=<?php echo $team['id']; ?>"><img src="<?php if(1==preg_match('/http:/',$team['image']))echo $team['image']; else echo '/static/'.$team["image"]; ?>" alt="<?=$team['title']; ?>" width="380" border="0" height="213"/></a>
    </div>
    ...
    <div class="small_bottom">
            ...
            <a href="/team.php?id=<?php echo $team['id']; ?>"><?=$team['title'];?></a>
            </div>
            ...
            <a href="<?php echo '/team.php?id='.$team['id']; ?>" class="knopka_ok"><?=(moneyit($team['team_comission'])!=0?'Купить':'Получить')?></a>
     </div>
