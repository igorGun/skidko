...
<div id="content-wrap">  <!--content start-->
  <div id="content">
    <div id="sidebar" >  <!-- left blck start-->
      <div class="sep"></div>
      <div class="sidebox">
       <ul class="sidemenu"><?php echo mcurrent_coupon('expire'); ?></ul>
      </div>
    ...
    <div id="main"> 
      <div class="box">
                    <h2>Истекшие <?php echo $INI['system']['couponname']; ?>ы</h2>
		
                <div id="list">
					<table id="orders-list" cellspacing="0" cellpadding="0" border="0" class="coupons-table">
					<tr><th width="100">Код</th><th width="440">Предложение</th><th width="180">Потребитель</th><th width="140">Дата</th></tr>
